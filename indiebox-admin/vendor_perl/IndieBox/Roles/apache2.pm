...
package IndieBox::Roles::apache2;
...
my $sitesDir         = '/etc/httpd/indiebox/sites';
my $appConfigsDir    = '/etc/httpd/indiebox/appconfigs';
...
CONTENT
    ...
    ScriptAliasMatch ^/\$ /usr/share/indiebox/cgi-bin/show-apps.pl
    ScriptAliasMatch ^/_appicons/([-a-z0-9]+)/([0-9]+x[0-9]+|license)\\.(png|txt)\$ /usr/share/indiebox/cgi-bin/render-appicon.pl
