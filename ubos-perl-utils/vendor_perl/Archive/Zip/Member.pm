...
# Patched by UBOS. Compare to http://svn.ali.as/cpan/trunk/Archive-Zip/lib/Archive/Zip/Member.pm:
# Look for "UBOS patch". Can be removed once fixed upstream.
